...
const SignUpScreen = ({ navigation }) => {
    ...
    return <SafeAreaView style={styles.container}>
        <View style={styles.content}>
            ...
            <View style={{flexDirection: "column", gap: 10, paddingHorizontal: 50}}>
            ...
            <View style={{flexDirection: "column", justifyContent: "center", gap: 15}}>
                ...
                <View style={{flexDirection: "row", justifyContent: "center"}}>
                    <Text style={{fontFamily: "Montserrat_300Light"}}>Already have an account? <Text
                        style={{color: colors.primary}} onPress={handleSignUp}>Sign in</Text></Text>
                </View>
            </View>
